/*
In a BST, an Inorder Successor of a node is defined as the node with the smallest key greater than the key of the input node. Given a node inputNode in a BST, you're asked towrite a func findInorderSuccessor that returns the Inorder Successor of the inputNode. If the inputNode has no Inorder Successor, return null.
*/
...
BinarySearchTree.prototype.findInOrderSuccessor = function(inputNode) {
    if (inputNode.right !== null) return inputNode.right;
    let currentNode = inputNode;
    while (currentNoe.parent !== null && currentNode.parent.right === currentNode) {
